...
//        private int getPreferredSize ( int value) {
//        	return 200;
//        }
    ...
    private class BaselineGroup extends ParallelGroup {
        ...
        int getBaseline() {
            if (springs.size() > 1) {
            	...
            	Spring spring = getSpring(springs.size());
            	spring.getPreferredSize(VERTICAL);
                return prefAscent;
            } else if (springs.size() == 1) {
    ...
    private final class ComponentSpring extends Spring {
        ...
        int getBaseline() {
            if (baseline == -1) {
                ...
                int height = horizontalSpring.getPreferredSize(VERTICAL);
                if (width > 0 && height > 0) {
